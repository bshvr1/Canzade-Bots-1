...
class Rolyonet extends Command {
 ...
 //       if (yetkiRolu.includes(role.id)) return this.client.yolla("Yetki rolleri ile işlem yapamazsın.", message.author, message.channel)
        ...
        if (banNum == Config.Limit.Role) return this.client.yolla("Gün içerisinde çok fazla rol işlemi uyguladığınız için komut geçici olarak kullanımınıza kapatılmıştır.", message.author, message.channel)
        if (args[0] == "al") {
